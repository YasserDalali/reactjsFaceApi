...
function Hexagon({className}) {
  return (
    <svg width="82" height="72" viewBox="0 0 82 72" fill="none" strokeWidth="6" xmlns="http://www.w3.org/2000/svg" className={twMerge('size-[1100px] text-teal-500/10 -rotate-6', className)}
    stroke='currentColor'
    >
